...
<?php
include('./admin_files/admin_header.php');
?>
...
<body>
            ...
            <div class="nk-nav-scroll">
                <ul class="metismenu" id="menu">
                    ...
                    <li>
                        ...
                        <li><a href="./admin_files/add_category.php">Add Category</a></li>
                        <li><a href="./admin_files/view_category.php">View Category</a></li>
  ...
  <?php
include('./admin_files/admin_footer.php');
  ?>